function [latent, latentLow, latentHigh] = pa_test_michael(x, nShuffle, alpha)
...
%modified by Michael Rosio for usage in the fmrib_fastr
...
for iShuffle = 1:nShuffle
        ...
        [~, ~ ,latentShuffle(:,iShuffle)] = pca_calc(xShuffle);
end
